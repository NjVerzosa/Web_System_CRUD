                    ...
                    <div class="card-body">
                        <form action="delete.php" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="password" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" class="form-control" >
                                <!-- pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" -->
                            </div>
                            <div class="mb-3">
                                <label>Age</label>
